...
/*
    $.get("/assets/components/hystrixCommand/templates/hystrixCircuit.html", function(data) {
      this.hystrixTemplateCircuit = data;
    }.bind(this));
    $.get("/assets/components/hystrixCommand/templates/hystrixCircuitContainer.html", function(data) {
      this.hystrixTemplateCircuitContainer = data;
    }.bind(this));
 ...
 */
HystrixCommandMonitor.prototype.eventSourceMessageListener = function(e) {
 ...
 * @param data
 */
HystrixCommandMonitor.prototype.displayCircuit = function(data) { 
  try {
    preProcessData(data);
  } catch (err) {
