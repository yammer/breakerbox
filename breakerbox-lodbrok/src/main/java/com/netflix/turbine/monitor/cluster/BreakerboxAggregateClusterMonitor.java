...
import com.yammer.breakerbox.lodbrok.turbine.BreakerboxClusterMonitor;
 ...
 *  @see InstanceMonitor
 */
public class BreakerboxAggregateClusterMonitor extends BreakerboxClusterMonitor<AggDataFromCluster> {
    ...
    public static final MonitorConsole<AggDataFromCluster> AggregatorClusterMonitorConsole = new MonitorConsole<AggDataFromCluster>();
    ...
    public static final TurbineDataDispatcher<DataFromSingleInstance> InstanceMonitorDispatcher = new TurbineDataDispatcher<DataFromSingleInstance>("ALL_INSTANCE_MONITOR_DISPATCHER");
    ...
    public static TurbineDataMonitor<AggDataFromCluster> findOrRegisterAggregateMonitor(String clusterName) {
        ...
        if (clusterMonitor == null) {
            ...
            clusterMonitor = new BreakerboxAggregateClusterMonitor(clusterName + "_agg", clusterName);
    ...
    public BreakerboxAggregateClusterMonitor(String name, String clusterName) {
        this(name,
    ...
    public BreakerboxAggregateClusterMonitor(String name,                          // the name of the cluster from which we are aggregating data
    ...
    public static class AggStatsEventHandler implements TurbineDataHandler<DataFromSingleInstance> {
        ...
        private BreakerboxAggregateClusterMonitor monitor;
        ...
        public AggStatsEventHandler(BreakerboxAggregateClusterMonitor monitor) {
