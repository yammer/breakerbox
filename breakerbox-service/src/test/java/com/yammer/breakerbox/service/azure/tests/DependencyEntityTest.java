...
public class DependencyEntityTest extends AbstractTestWithConfiguration {
    ...
    public void tearDown() {
        TableClientTestUtils.tearDownTestTable(tableClient, DependencyEntity.build(dependencyId, testTimeStamp, user, DependencyEntity.defaultConfiguration(), serviceId));
    }
