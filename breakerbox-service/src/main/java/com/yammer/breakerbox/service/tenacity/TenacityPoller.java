...
public class TenacityPoller extends TenacityCommand<ImmutableList<String>> {
    ...
    @Override
    protected ImmutableList<String> run() throws Exception {
        return tenacityClient.getTenacityPropertyKeys(uri).get();
    }

    @Override
    protected ImmutableList<String> getFallback() {
